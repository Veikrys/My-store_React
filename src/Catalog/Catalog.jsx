...
import Products from '../welcome/sale/products/products'
...
function Catalog () {
    return (
        <section className={mod.main}>
            <div className={mod.header}><Header /></div>
            ...
            <div>
                <h1 className={mod.title}>Catalog</h1>
            </div>
            <div className={mod.products}>
              <div className={mod.prSet}>
                <div className={mod.pr}>
                <Products i = {0} />
                </div>
                <div className={mod.pr}>
                <Products i = {1} />
