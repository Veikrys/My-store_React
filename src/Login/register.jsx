...
function Login () {
    return(
        <section className={mod.main}>
            ...
            <h1 className={mod.title}>Log in profile</h1>
            <section className={mod.form}>
            <div className= {mod.email}>
                <input placeholder='E-mail' ></input>
            </div>
            <div className= {mod.pass}>
                <input placeholder='Password' ></input>
            </div>
            <p className={mod.forgive}><a href='sss'>Не помню пароль</a></p>
            <button className={mod.log}>Log in</button>
            <NavLink to = '/register'><button className={mod.reg}>Registration</button></NavLink>
            </section>
